...
STEP_10_GUI_7() throws InterruptedException {
    ...
    while(true){
        ...
        switch(ewsn){
            case Up: cy -= disp; if (cy < 0) cy = 0;
                break;
            case Dn: cy += disp; if (360-50 < cy) cy = 360-50;
                break;
            case Rt: cx += disp; if (400-50 < cx) cx = 400-50;
                break;
            case Lt: cx -= disp; if (cx < 0) cx = 0;
                break;
        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Consple thread is going out!!!");
    }
}
